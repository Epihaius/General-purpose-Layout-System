...
# (objects with a position and size) in 2D-space.
...
class Sizer:
    ...
    def owner(self, owner):
        ...
        if owner and owner.type == "primitive":
            l, r, b, t = owner.sizer_borders
            w, h = owner.native_size
            self._pos = (l, t)
            self.default_size = (w - l - r, h - b - t)

    @property
    def owner_primitive(self):
    ...
    def get_primitives(self, include_attached=True):
        ...
        for cell in self._cells:
            ...
            if cell.type == "primitive":
                ...
                if include_attached:
                    ...
                    sizer = primitive.sizer

                    if sizer:
                        primitives.extend(sizer.get_primitives())

            elif cell.type == "sizer":

                primitives.extend(cell.object.get_primitives(include_attached))
    ...
    def set_min_size_stale(self, stale=True):
        ...
        if stale and self._owner:
            ...
            elif self._owner.type == "primitive":
